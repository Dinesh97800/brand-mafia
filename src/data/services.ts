...
export const services: Service[] = [
  ...
  },
  {
    ...
    relatedIds: ["web-dev", "social", "video-production"],
  ...
  },
  {
    ...
    relatedIds: ["digital-marketing", "social", "web-dev"],
  ...
  },
  {
    ...
    relatedIds: ["seo", "web-dev", "performance"],
    blogSlug: "local-seo-for-local-businesses",
  ...
  // },
  {
    ...
    relatedIds: ["web-dev", "branding", "digital-marketing"],
    blogSlug: "websites-around-customers-not-templates",
